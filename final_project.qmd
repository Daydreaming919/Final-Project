...
Pisa Data is very heavy. For example, the Pisa 2022 student data contains 613,744 observations and 1,278 variables. Therefore, I first have done a basic cleaning on the 2003-2022 data. I referred to the learningtower cleaned the Pisa data to choose these important columns, but not all of these colunms will necessarily be used in later research.
